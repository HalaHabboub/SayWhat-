...
import type { TranslationTone } from "@/app/audio-translation/page"

interface AudioConfigurationStepProps {
...
export function AudioConfigurationStep({
  targetLanguage,
  tone,
  summarize,
  generateBanner,
  ...
  onNext,
  onBack,
}: AudioConfigurationStepProps) {
  return (
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-2xl font-bold mb-2">Configure Translation</h2>
        <p className="text-muted-foreground">Customize your audio translation settings</p>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Generate a concise summary of the transcription</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/50">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">Add time markers to the transcription</p>
              </div>
              <Switch id="timestamps" checked={includeTimestamps} onCheckedChange={onIncludeTimestampsChange} />
            </div>
